...
function assign_bootstrap_mode() {
    ...
    if (width < 768) {
        ...
        $('.dropdown-submenu .dropdown-menu li a').on('touchstart',
                function(e) {
                    e.preventDefault();
    ...
    $("body").removeClass("mode-xs").removeClass("mode-sm").removeClass(
            "mode-md").removeClass("mode-lg").addClass(mode);
}
/*-----------------------------------------------------------------------------------*/
/*
 * CONTENT SLIDER
                ...
                function() {
                    ...
                    jQuery.fn.extend({
                        unwrapInner : function(selector) {
                            return this.each(function() {
                                var t = this, c = $(t).children(selector);
                                if (c.length === 1) {
                    ...
                    function getUrlVars(hashdivider) {
                        ...
                        var hashes = window.location.href.slice(
                                window.location.href.indexOf(hashdivider) + 1)
                                .split('_');
                            ...
                            .each(
                                    function(i) {
                                        ...
                                        if (jQuery.support.leadingWhitespace == false) {
                                            ...
                                            // THE HANDLING IN CASE ITEM IS
                                            // CLICKED
                                            item
                                                    .click(function() {
                                                        item
                                                                .addClass("clicked-no-slide-anim");
                                                        var cur = item
                                                                .data('index');
                                                                                    ...
                                                                                    .load(
                                                                                            ...
                                                                                            function() {
                                                                                                ...
                                                                                                jQuery(
                                                                                                        ...
                                                                                                        .html(
                                                                                                                jQuery(
                                                                                                                        '.fullcontent-content-wrapper-new .title')
                                                                                                                        .html())
                                                                                                        .removeClass(
                                                                                                                "novisibility");
                                                                                                animateContents(
                    ...
                    function animateContents(mainContOut, oldbody, newbody,
                            speed) {
                        ...
                        newbody.removeClass('preparedtostart').addClass(
                                'preparedtoleave');
            ...
            $('.testimonials').owlCarousel(
                    {
                        items : 1,
                        nav : true,
                        navText : [ '<i class="icon-left-open-big"></i>',
...
$(document).ready(
        function() {
            ...
            var menu = $('.navbar'), pos = menu.offset();
                        ...
                        if ($(this).scrollTop() > pos.top + menu.height()
                            ...
                            menu.fadeOut('fast', function() {
                                $(this).removeClass('default')
                                        .addClass('fixed').fadeIn('fast');
                            });
                        } else if ($(this).scrollTop() <= pos.top + 200
                                && menu.hasClass('fixed')) {
                            menu.fadeOut(0, function() {
                                $(this).removeClass('fixed')
                                        .addClass('default').fadeIn(0);
                            });
                        }
                    });
...
$(document)
        .ready(
                function() {
                    ...
                    $('.anchor').css('padding-top',
                            shrinked_header_height + 'px');
                    ...
                    $(window)
                            .scroll(
                                    function() {
                                        ...
                                        scrollPosition = parseInt($(this)
                                                .scrollTop());

                                        // Move trough each menu and check its
                                        // position with scroll position then
                                        // add current class
                                        $('.navbar ul a')
                                                .each(
                                                        function() {
                                                            ...
                                                            thisHref = $(this)
                                                                    .attr(
                                                                            'href');
                                                            thisTruePosition = parseInt($(
                                                                    thisHref)
                                                                    .offset().top);
                                                            thisPosition = thisTruePosition
                                                                    - headerWrapper
                                                                    - offsetTolerance;
                                        ...
                                        // move pointer to the last section
                                        bottomPage = parseInt($(document)
                                                .height())
                                                - parseInt($(window).height());

                                        if (scrollPosition == bottomPage
                                                || scrollPosition >= bottomPage) {

                                            $('.current')
                                                    .removeClass('current');
                                            $('.navbar ul a:last').parent('li')
                                                    .addClass('current');
                                        }
                                    });
